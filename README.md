...
- `vortex.sh` variables:
  ...
  - For service auto-enrollment, set `VORTEX_GATEWAY_URL`, `VORTEX_BOOTSTRAP_TOKEN`, and `VORTEX_WORKSPACE_ID`. Generic aliases alone do not trigger Vortex service installation.
